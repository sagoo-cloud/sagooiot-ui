	...
	<div class="monitor-weather">
		<div class="left">
			...
			<div class="city-weather-data-overview-wrap">
				...
				<section v-for="(item, index) in cityList" :key="index">
					<span>{{item.cityName}}</span>
					<span>{{item.force}}</span>
					<span>{{item.sunshine}}</span>
				</section>
			</div>
		</div>
		<div class="right">
			<el-row :gutter="15" class="home-card-two mb15">
				<el-col >
					<div class="home-card-item">
						<div class="home-card-item-title">温度   监测图表</div>
			...
			<el-row :gutter="15" class="home-card-three">
				<el-col>
					<div class="home-card-item">
						<div class="home-card-item-title">风力   监测图表</div>
