  ...
  <div class="system-dic-container">
    <el-card shadow="hover">
     ...
     <div style="border: 1px solid var(--next-border-color-light);"></div> 
       <el-row>
    <el-col  :span="6" v-for="(item, index) in tableData.data" :key="index"><div class="grid-content card">
    
    		<div class="ant-card" >
				<div class="ant-card-body">
								
                    <div class="pro-table-card-item">
                        <div class="card-item-avatar"><img width="88" height="88"
                        ...
                        <div class="card-item-body">
                            <div class="card-item-header">
                                <div class="ellipsis-warp___1lAFU">
                                    <div class="ellipsis card-item-header-name"
                                        style="width: 100%;    height: 45px;">{{item.name}}</div>
                                    <div class="card-item-header-name " style="display: none"></div>
                                </div>
                            </div>
                            <div class="card-item-content">
                                <div><label>触发方式</label>
                                    <div class="ellipsis-warp___1lAFU">
       ...
       <div class="card-button">
                        <el-button size="default" type="warning" text bg  @click="resetQuery(queryRef)">
              <el-icon>
                <ele-Check />
              </el-icon>
              启用
                       ...
                       <el-button size="default" type="danger" text bg @click="resetQuery(queryRef)">
              <el-icon>
                <ele-Delete />
              </el-icon>
              删除
...
.card-state {
    ...
    width: 100px;
    padding: 2px 0;
    background-color: rgba(89,149,245,.15);
...
.card-tools .card-button>span,  .card-tools .card-button button {
    width: 100%;
    border-radius: 0;
}
